...
Doc 04 has been amended by slice 1 (DM-06, DM-06a, DM-06b), slice 2 (DM-20a), slice 3 (DM-23a), slice 3b (DM-24a) and slice 4 (DM-31a). Doc 03 §2.1 / FIN-20 were amended by slice 3b (F-1: withholding is a fourth balance instrument).
...
Slices 1–4 proceeded on the documented defaults (A-01…A-05, A-11, A-12). **Slice 3b built E1 on a
