...
description: |
  Code review guidance for this project's stack: C#/.NET, TypeScript, React,
  Python/FastAPI, and SQL. Covers architecture review, performance review,
  security audit, code quality anti-patterns, and common bugs.
...
> Vendored subset: only the guides for this project's stack are included
> (see `docs/README.md`). Upstream also ships guides for Angular, Vue, Svelte,
> Rust, Go, Java, Kotlin, Swift, Dart, PHP, Ruby, Django, C/C++, Zig, Qt,
> NestJS and CSS/Less/Sass; they were left out deliberately.
